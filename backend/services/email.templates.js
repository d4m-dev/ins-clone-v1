...
const COPY = {
  vi: {
    ...
    newPhoto: {
      ...
      preview: '{{author}} vừa chia sẻ lên PixGram',
      heading: '{{author}} vừa đăng {{kind}} mới',
      intro: 'Một khoảnh khắc mới vừa được đăng lên cộng đồng.',
      ...
      duration: 'Thời lượng',
      cta: 'Mở PixGram',
      footer: 'Bạn nhận được email này vì là quản trị viên của PixGram.',
    },
    invite: {
      subject: '💌 {{inviter}} mời bạn tham gia cộng đồng',
      preview: '{{inviter}} đã tạo tài khoản cho bạn',
      heading: '{{inviter}} mời bạn tham gia PixGram',
      intro: 'Đây là nơi mọi người chia sẻ ảnh — không quảng cáo, không thuật toán.',
    ...
    reset: {
      subject: '🔑 Đặt lại mật khẩu PixGram',
    ...
    welcome: {
      subject: '🎉 Chào mừng {{name}} đến với PixGram',
      ...
      cta: 'Mở PixGram',
      footer: 'Ảnh được lưu trên máy chủ riêng — không nằm trên đám mây công cộng.',
    },
  },
  ...
  en: {
    ...
    newPhoto: {
      ...
      preview: '{{author}} shared something on PixGram',
      heading: '{{author}} just posted a new {{kind}}',
      intro: 'A new moment was just posted to the community.',
      kindPhoto: 'photo',
      kindVideo: 'video',
      caption: 'Caption',
      location: 'Location',
      duration: 'Duration',
      cta: 'Open PixGram',
      footer: 'You are receiving this because you are an administrator of PixGram.',
    },
    invite: {
      subject: '💌 {{inviter}} invited you to join',
      preview: '{{inviter}} created an account for you',
      heading: '{{inviter}} invited you to PixGram',
      intro: 'This is where people share photos — no ads, no algorithm.',
    ...
    reset: {
      subject: '🔑 Reset your PixGram password',
  ...
  zh: {
    ...
    newPhoto: {
      ...
      preview: '{{author}} 在 PixGram 分享了新内容',
      ...
      duration: '时长',
      cta: '打开 PixGram',
      footer: '您收到此邮件是因为您是 PixGram 的管理员。',
    },
    invite: {
      subject: '💌 {{inviter}} 邀请您加入',
      preview: '{{inviter}} 为您创建了账号',
      heading: '{{inviter}} 邀请您加入 PixGram',
      intro: '这里是大家分享照片的地方 —— 没有广告，没有陌生人。',
      detail: '注册邮箱：{{email}}',
    ...
    welcome: {
      subject: '🎉 欢迎 {{name}} 加入 PixGram',
      preview: '您的账号已就绪',
      heading: '欢迎，{{name}}！',
      intro: '您的账号已创建。登录并分享第一张照片吧。',
      cta: '打开 PixGram',
      footer: '照片保存在自己的服务器上 —— 不在公共云上。',
    },
  },
};
  ...
  <table role="presentation" width="100%" cellpadding="0" cellspacing="0" style="background:${BRAND.bg};padding:24px 12px;">
    <tr><td align="center">
      ...
      <p style="max-width:520px;margin:14px auto 0;color:${BRAND.soft};font-size:11px;text-align:center;">
        ${escapeHtml(appName)} · nơi mọi người chia sẻ ảnh
      </p>
    </td></tr>
  </table>
</body></html>`;
